...
public class DrilledObjectController : MonoBehaviour
{
	...
	void Update()
	{
		...
		//top 0.5 0.5
		Vector3 tf1 = new Vector3(radius, 5, radius) + offset;
		Vector3 tc1 = tf1 + dir.normalized * 0.05f;
		topVertices[1] = tf1;
		topVertices[4] = tf1;
		...
		//top 0.5 -0.5
		Vector3 tf2 = new Vector3(radius, 5, -radius) + offset;
		Vector3 tc2 = tf2 + dir.normalized * 0.05f;
		topVertices[0] = tf2;
		topVertices[8] = tf2;
		topVertices[13] = tf2;
		...
		//top -0.5 0.5
		Vector3 tf3 = new Vector3(-radius, 5, radius) + offset;
		Vector3 tc3 = tf3 + dir.normalized * 0.05f;
		topVertices[5] = tf3;
		topVertices[10] = tf3;
		topVertices[16] = tf3;
		...
		//top -0.5 -0.5
		Vector3 tf4 = new Vector3(-radius, 5, -radius) + offset;
		Vector3 tc4 = tf4 + dir.normalized * 0.05f;
		topVertices[12] = tf4;
		topVertices[17] = tf4;
		topVertices[20] = tf4;
		topVertices[22] = tf4;
		...
		//bottom 0.5 0.5
		Vector3 bf1 = new Vector3(radius, 5, radius) + offset + dir;
		Vector3 bc1 = bf1 - dir.normalized * 0.05f;
		...
		//bottom 0.5 -0.5
		Vector3 bf2 = new Vector3(radius, 5, -radius) + offset + dir;
		Vector3 bc2 = bf2 - dir.normalized * 0.05f;
		...
		//bottom -0.5 0.5
		Vector3 bf3 = new Vector3(-radius, 5, radius) + offset + dir;
		Vector3 bc3 = bf3 - dir.normalized * 0.05f;
		...
		//bottom -0.5 -0.5
		Vector3 bf4 = new Vector3(-radius, 5, -radius) + offset + dir;
		Vector3 bc4 = bf4 - dir.normalized * 0.05f;
